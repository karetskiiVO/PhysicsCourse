...
namespace Task3 {
    public class DistanceJointBaumgarteSystem : IEcsRunSystem {
        ...
        public void Run() {
            ...
            foreach (var idx in joints) {
                ...
                var bias = joint.baumgarte * stretch / Mathf.Max(Mathf.Epsilon, dt);
                var impulseMagnitude = -(relativeVelocity + bias) / invMass;
