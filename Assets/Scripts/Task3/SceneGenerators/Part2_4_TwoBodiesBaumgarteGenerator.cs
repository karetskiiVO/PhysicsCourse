...
namespace Task3.SceneGenerators {
    public class Part2_4_TwoBodiesBaumgarteGenerator : SceneGeneratorBase {
        protected override void GenerateScene() {
            ...
            var bodyA = CreateRigidBody(
                position: new Vector3(-0.8f, 0.85f, 0f),
                rotation: Quaternion.identity,
                size: bodySize,
                mass: 1f,
                angularVelocity: Vector3.zero,
            ...
            var bodyB = CreateRigidBody(
                position: new Vector3(0.9f, -0.25f, 0f),
                rotation: Quaternion.identity,
                size: bodySize,
                mass: 1f,
                angularVelocity: Vector3.zero,
            ...
            ecsSystems
                ...
                .Add(new DistanceJointBaumgarteSystem())
