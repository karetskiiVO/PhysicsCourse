...
namespace Task3.SceneGenerators {
    public class Part2_5_TwoBodiesNgsGenerator : SceneGeneratorBase {
        protected override void GenerateScene() {
            ...
            var bodyA = CreateRigidBody(
                position: new Vector3(-0.85f, 0.9f, 0f),
                rotation: Quaternion.identity,
                size: bodySize,
                mass: 1f,
                angularVelocity: Vector3.zero,
            ...
            var bodyB = CreateRigidBody(
                position: new Vector3(1f, -0.15f, 0f),
                rotation: Quaternion.identity,
                size: bodySize,
                mass: 1f,
                angularVelocity: Vector3.zero,
            ...
            ecsSystems
                ...
                .Add(new DistanceJointNgsSystem());
        }
    }
}
